...
public record MarketComparisonResponse(
    ...
    public static MarketComparisonResponse unavailable(String message) {
        return new MarketComparisonResponse("UNAVAILABLE", null, null, null, null, message);
    }

    public static MarketComparisonResponse available(
            long referencePrice, double differenceRate, int sampleCount, String referenceDate
    ) {
        return new MarketComparisonResponse("AVAILABLE", referencePrice, differenceRate, sampleCount, referenceDate, null);
    }
}
